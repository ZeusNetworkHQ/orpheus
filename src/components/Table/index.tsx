...
const TableHeader = () => {
  ...
  return (
    <div
      ...
      style={{
        gridTemplateColumns: `${getGridTemplateColumns(columnSizes)}`,
      }}
    >
    ...
    <TableContext.Provider value={rowContext}>
      <div
        className={classNames(
          ...
          tableType === "stacked" &&
            variant === "separated" &&
            "bg-sys-color-background-card gradient-border before:from-apollo-border-15 before:to-apollo-border-10 rounded-16 flex w-full min-w-full flex-wrap gap-y-0 p-8 pb-12 md:grid md:gap-y-0 md:rounded-none md:border-none md:bg-transparent md:p-0 md:pb-0 md:before:hidden",
          tableType === "stacked" &&
            variant === "separated" &&
            width === "auto" &&
            "md:w-max",
        ...
        {rightIcon &&
          (rightIconOnClick ||
            ...
            <button
              ...
              className="hover:text-sys-color-text-primary transition"
            >
              <Icon
                name={rightIcon}
                size={rightIconSize}
